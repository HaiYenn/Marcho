        ...
        <div class="panel-body">
          <form action="{{route('product.store')}}" method="POST" role="form" enctype="multipart/form-data">
            ...
            <div class="form-group   @error('pro_name') has-error @enderror ">
              ...
              <input type="text" class="form-control" id="" placeholder="Tên sản phẩm...." name="pro_name">
               @error('pro_name')
            ...
            <div class="form-group   @error('title') has-error @enderror">
             ...
             <div class="form-group  @error('price') has-error @enderror ">
              <label for="">Giá</label>
              <input type="textarea" class="form-control" id="" placeholder="Tên sản phẩm...." name="price">
              @error('price')
                  <div class="help-block">{{ $message }}</div>
              @enderror
            </div>
