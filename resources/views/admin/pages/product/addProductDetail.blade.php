      ...
      <div class="col-md-9">
       <div class="panel panel-info">
        ...
        <div class="panel-body">
          <form action="{{route('productDetail.store')}}" method="POST" role="form" enctype="multipart/form-data">
          ...
          @csrf
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="" placeholder="Tên sản phẩm...." name="quantity">
            </div>

            <div class="form-group">
              <label for="">Giảm giá</label>
              <input type="textarea" class="form-control" id="" placeholder="Tên sản phẩm...." name="discount">
            </div>
